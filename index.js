...
async function sendCopyButtons(
  ...
  for (
    ...
    /*
     * WhatsApp rate-limit / ordering সমস্যা
     * এড়াতে সামান্য delay
     */
    await new Promise(
      resolve =>
...
`;
    ...
    /*
     * Admin Panel-এর প্রতিটি
     * control-এর Copy Button
     */
    await sendCopyButtons(
      remoteJid,
      [
            ...
            try {
              ...
              if (
                ...
                if (!admin) {
                  ...
                  /*
                   * কোনো reply নয়।
                   * সাধারণ member Admin Panel
                   * বা Admin Control দেখতে পারবে না।
                   */
                  continue;
                }
              }
